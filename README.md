...
* [x] User can only submit valid tweets.
...
<img src='https://github.com/EvanCornish/MySimpleTweets/blob/master/MySimpleTweetsGIF.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

I ran into a few small challenges throughout the building of the app, some with code and some with the use of Android Studio.
